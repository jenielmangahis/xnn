...
<div class="historical-commission tool-container tool-container--default" v-cloak>
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="admin-money-title">Historical Commission</h4>
        </div>
    </div>
    ...
    <div class="put-mobile-lr-padding">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <a
                                ...
                                v-on:click.prevent="getCommissionPeriods" class="help-block text-danger">Unable to fetch. Click here to try again.
                            </a>
                ...
                <div class="row margin-top">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="invoice" name="invoice" v-model="invoice" class="form-control" placeholder="DFO#####"/>
                        </div>
                    </div>
                ...
                <div class="row margin-top-bottom padding-left-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="total-style-controller">
                                    <h5 class="admin-money-total"><strong>Total {{ total | money }}</strong></h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 padding-left-right">
                            <table id="table-historical-commission" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                ...
                                <tr class="table__row">
                                    ...
                                    <td class="table__cell">Amount Earned</td>
