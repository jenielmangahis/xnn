...
<div class="historical-commission tool-container tool-container--default" v-cloak>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="card border-left-info shadow h-100 py-2" style="height: 100% !important;" style="background-color:white !important;">
                <div class="card-header py-4 d-flex flex-row align-items-center justify-content-between">
                    <h5 class="m-0 font-weight-bold text-primary text-uppercase">HISTORICAL COMMISSION</h5>
                </div>
                <div class="card-body">
