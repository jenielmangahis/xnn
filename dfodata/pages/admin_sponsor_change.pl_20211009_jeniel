...
<div class="tool-container tool-container--default" id="sponsor-change" v-cloak>
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="admin-money-title">Sponsor Change</h4>
        </div>
    </div>
            ...
            <div class="tab-content" style="padding: 15px;border: 1px solid #ddd;border-top: none;">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab-tool">
                    ...
                    <div class="row margin-top-bottom">
                        ...
                        <div class="col-md-3">
                            <label>Select which member to move</label>
                        ...
                        <div class="col-md-3">
                            <label>&nbsp;</label><br>
                            <button :disabled="!!is_processing" v-on:click.prevent="viewDetails" class="btn btn-primary btn-block" type="button">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="admin-money-label margin-bottom">Current Relationship</label>
                        ...
                        <div class="col-md-6">
                            <label class="admin-money-label margin-bottom">After the Change</label>
                            <table class="table table-striped table-bordered table-relationship">
                                <thead>
                                <tr>
                                    <th>ID</th>
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" id="table-history" style="width:100%">
                                    ...
                                    <tr class="table__row">
                                        ...
                                        <td class="table__cell">New Sponsor</td>
                                        <td class="table__cell">Old Sponsor</td>
                                        <td class="table__cell">Tree</td>
                                        <td class="table__cell">Move By</td>
