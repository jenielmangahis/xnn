    ...
    const vm = new Vue({
        ...
        methods: {
                    ...
                    columns     : [
                        {
                            ...
                            render: function (data, type, full, meta){
                                ...
                                return `<input class="row-selected" ${vm.selectedIds.includes(full.ids) ? "checked" : ""} type="checkbox" name="id[]" value="1">`;
                            }
                        },
                        {
                            data: 'name',
            ...
            markAsPaid(payout_ids) {
                ...
                swal({
                    title: "Mark as paid",
                    text: "Are you sure you want to manually mark this as paid? The payout will NOT be included in the ACH files.",
                    type: "warning",
                    confirmButtonClass: "btn-success",
                    confirmButtonText: "Confirm",
                    cancelButtonText: "Cancel",
            ...
            download(id, fileId) {
                return `${api_url}admin/pay-commission/download/${id}/${fileId}?token=${commissionEngine.ACCESS_TOKEN}`
            }
        },
        computed: {
            progress() {
