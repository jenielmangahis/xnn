...
Route::prefix('member/dashboard')->namespace('Member')->middleware('jwt.auth')->group(function(){
    ...
    Route::get('earnings', 'DashboardController@earnings');
    Route::get('qualifications', 'DashboardController@qualifications');
    Route::get('product-credits', 'DashboardController@productCredits');
    Route::get('product-credit-balance', 'DashboardController@productCreditBalance');
});
...
Route::prefix('admin/pay-commission')->namespace('Admin')->middleware('jwt.auth.level:1,6')->group(function () {
    ...
    Route::get('download/{id}/{file_id}', 'PayCommissionController@download');
});
...
Route::prefix('admin/sponsor-change')->namespace('Admin')->middleware('jwt.auth.level:1,6')->group(function () {
    ...
    Route::post('roll-up', 'SponsorChangeController@rollUp');
});
...
Route::prefix('admin/search')->namespace('Admin')->middleware('jwt.auth.level:1,6')->group(function () {
    Route::get('volumes-and-ranks', 'SearchController@volumesAndRanks');
    Route::get('downline/parent/{id}', 'SearchController@parent');
    Route::get('downline/parent/{id}/children/{page_no}', 'SearchController@children');
    Route::get('order-history', 'SearchController@orderHistory');
});