    ...
    const vm = new Vue({
        ...
        mounted() {
            this.hadSignup(had_signup => {
                ...
                if(! this.had_signup) {
                    // window.location.replace("https://office.stg1-opulenza.xyz/nxm_money.cgi?p=affiliate_payquicker");
                    return;
                }
            });
        ...
        methods: {
            ...
            axiosErrorHandler(error) {
                ...
                console.log("error", commissionEngine.parseAxiosErrorData(error));
            ...
            transferFund() {
                if(!this.transfer.member_id) {
                    swal("Member is Required");
                    return;
                }

                if(this.transfer.amount <= 0) {
                    swal("Please Enter Amount to Transfer");
                    return;
                }
            ...
            withdrawFund() {
                if(this.withdraw.amount <= 0) {
                    swal("Please enter amount to withdraw!");
                    return;
                }
                ...
                swal({
                    ...
                    icon: "warning",
                    confirmButtonClass: "btn-success",
                    buttons:['Cancel', 'Confirm Withdraw'],
                    confirmButtonClass: "btn-success",
                    closeModal: true
                })
                .then(withdrawFund => {
