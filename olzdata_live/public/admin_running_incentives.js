    ...
    const vm = new Vue({
        ...
        methods: {
                    ...
                    columns: [
                        ...
                        {data: 'period'},
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return `<div class="text-right"><button class="btn btn-secondary btn-view-representatives btn-action">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                        </button>
                                        <button class="btn btn-secondary btn-edit-representatives btn-action">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                        <button class="btn btn-secondary btn-download-representatives btn-action">
                                            <i class="fa fa-download" aria-hidden="true" v-bind:disabled="_this.downloadLinkState === 'fetching'"></i>
                                        </button>
                                        <button class="btn btn-danger btn-delete-incentive btn-action">
                ...
                $dtClosed = $("#close_incentives").DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'period'},
                        {
                            ...
                            width: '200px',
                            render: function (data, type, row, meta) {
                                return `<div class="text-right"><button class="btn btn-secondary btn-action btn-hide-incentive">
                                            <i class="fa fa-eye-slash" aria-hidden="true"></i>
                                        </button>
                                        <button class="btn  btn-secondary btn-action btn-view-representatives">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                        </button></div>`;
                            }
                        },
                ...
                var members = new Bloodhound({
                    ...
                    remote: {
                        ...
                        prepare: function(query, settings){
                            settings.url += '?q=' + query +'&f='+$('#member-filter-by').val()+"&s="+_this.arbitrary.incentive_id;
                            return settings;
                        },
                        wildcard: '%QUERY',
                    }
            ...
            deleteIncentiveSettings(settings_id, title) {
                swal({
                    title: "Delete Incentive Settings",
                    text: "Are you sure you want to delete " + title +" Incentive Settings?",
                    icon: "warning",
                    confirmButtonClass: "btn-success",
                    buttons: ["No, cancel please!", "Yes!"],
                  })
            ...
            createIncentive() {
                ...
                swal({
                    title: "Create New Incentive Settings",
                    text: "Are you sure you want to create this Incentive Settings?",
                    icon: "warning",
                    confirmButtonClass: "btn-success",
                    buttons: ["No, cancel please!", "Yes!"],
                  })
            ...
            updateIncentive() {
                ...
                swal({
                    title: "Update Incentive Settings",
                    text: "Are you sure you want to update this Incentive Settings? Name:"+ this.settings.title,
                    icon: "warning",
                    confirmButtonClass: "btn-success",
                    buttons: ["No, cancel please!", "Yes!"],
                  })
            ...
            addBonusPoints() {
                ...
                if(this.arbitrary.incentive_id <= 0) {
            ...
            clearRunningIncentiveTab() {
                ...
                $('.prev-tab').trigger( "click");
                
            },
            clearArbitraryTab() {
                $('.clear-typeahead').trigger( "click");
                this.arbitrary.incentive_id = 0;
