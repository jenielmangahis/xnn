...
use App\Console\Commands\Commission\RunSilverStartUpProgram;
use App\Console\Commands\Commission\RunVolumesAndRanks;
use App\Console\Commands\Commission\SetPurchaserSponsorCategoryID;
use App\Console\Commands\Commission\RunSparkleStartProgram;
use App\Console\Commands\Commission\RunDailyIncentivePointsTracker;
use App\Console\Commands\Commission\RunHostessRewards;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        RunSparkleStartProgram::class,
        RunDailyIncentivePointsTracker::class,
        RunSilverStartUpProgram::class,
        RunHostessRewards::class
    ];
