    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" role="tablist" id='nav-tab-report'>
                <li class="nav-item">
                    <a class="nav-link active" href="#tab-pay" aria-controls="tab-pay" role="tab" data-toggle="tab" style="color: black !important;">Request</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#tab-history" aria-controls="tab-history" role="tab" data-toggle="tab" style="color: black !important;">Approval History</a>
                </li>
            </ul>         
                        ...
                        <div class="col-md-4">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary btn-block" id="btn-view" v-on:click.prevent="viewRequest">View</button>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table--align-middle" id="table-main" style="width: 100%">
                                    ...
                                    <tr class="table__row">
                                        ...
                                        <th class="table__cell">Representative ID</th>
