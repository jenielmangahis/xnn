                        ...
                        <div class="col-md-10">
                            <form class="form-horizontal ">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-2 col-md-3 col-6">
                                        <button type="button" class="btn btn-primary btn-block" id="button-generate-report">Search</button>
                                    </div>
                                </div>
                             </form>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table-admin-group-sales" class="table table-striped table-bordered dt-responsive nowrap"
                                    style="width:100%">
...
<script src="$commission_engine_api_url/js/admin_group_sales.js"></script>
