    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal">
                ...
                <div class="form-group row">
                    <div class="form-sub-group col-md-4 col-sm-12 col-xs-12">
                        <button v-if="background == null || background.is_running !== 'YES'" v-on:click="run" :disabled="commissionType === '' || commissionPeriod === '' || is_generating == 1 ? true : false" class="btn btn-primary btn-block" type="button">
                            <span v-if="is_generating == 0">Generate</span>
                            <span v-else>Generating <i class="fa fa-spinner fa-pulse fa-fw"></i></span>
                        </button>
                        <button v-on:click="cancelRun" v-else class="btn btn-danger btn-block" type="button" :disabled="is_cancelling == 1 ? true : false">
                ...
                <div class="row" v-if="commissionType != '' && commissionPeriod != '' && background == null">
                    <div class="form-sub-group col-lg-4">
                        <button :disabled="is_viewing_previous_run == 1 ? true : false" v-if="commissionType != '' && commissionPeriod != '' && background == null && is_generating == 0" v-on:click="viewPreviousRun" class="btn btn-secondary btn-block" type="button">
    ...
    <div class="row" v-show="background != null">
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div v-if="background != null && (background.download_link != '' && background.download_link != null)">
                            <a class='btn btn-secondary btn-block run-commission__download-link'  :href="background != null ? background.download_link : ''" download>
                                <i class="fa fa-th-list" aria-hidden="true"></i> Download Commission Payouts
                            </a><br />
                            <a class='btn btn-secondary btn-block run-commission__download-link'  :href="background != null ? background.download_details_link : ''" download>
            ...
            <div v-if="background != null && background.is_running == 'COMPLETED'">
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        <button type="button" class="btn btn-primary btn-block" v-on:click="lockCommissionPeriod" :disabled="is_locking == 1 ? true : false">
