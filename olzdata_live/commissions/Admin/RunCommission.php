...
class RunCommission
{
    ...
    public static function getCommissionTypeClass($commission_type_id, $commission_period_id, $background_worker_id = null, $background_worker_process_id = null)
    {
        ...
        switch (+$commission_type_id) {
            ...
            break;
            case config('commission.commission-types.monthly-level-commission'):
                return new MonthlyLevelCommission($period, $background_worker_logger, $payout_repository);
            break;
            // case config('commission.commission-types.sparkle-level-commission'):
            //     return new SparkleStartProgram($period, $background_worker_logger, $payout_repository);
            // break;
            case config('commission.commission-types.silver-start-up'):
                return new SilverStartUp($period, $background_worker_logger, $payout_repository);
            break;
            case config('commission.commission-types.rank-advancement-bonus'):
                return new RankAdvancementBonus($period, $background_worker_logger, $payout_repository);
            break;
            case config('commission.commission-types.rank-consistency-bonus'):
                return new RankConsistency($period, $background_worker_logger, $payout_repository);
            break;
            default:
