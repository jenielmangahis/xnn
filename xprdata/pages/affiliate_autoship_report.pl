    ...
    <div class="row">
        <div class="col-md-6">
            <table class="table table-striped table-bordered" id="metric-total" >
                ...
                <tr class="table__row">
                    <td class="table__cell">Monthly Personally Enrolled Retention Rate</td>
                    <td class="table__cell">
                        <i v-if="metrics.personallyEnrolledRetentionRate === null" class="fa fa-spinner fa-spin"></i>
                        <span v-else>{{ metrics.personallyEnrolledRetentionRate }}%</span>
                    </td>
                </tr>
                <tr class="table__row">
                    <td class="table__cell">Monthly Organizational Retention Rate</td>
                    <td class="table__cell">
                        <i v-if="metrics.organizationalRetentionRate === null" class="fa fa-spinner fa-spin"></i>
                        <span v-else>{{ metrics.organizationalRetentionRate }}%</span>
                    </td>
                </tr>
                </tbody>
            </table>
...
<script src="$commission_engine_api_url/js/affiliate_autoship_report.js?v=1.0"></script>
