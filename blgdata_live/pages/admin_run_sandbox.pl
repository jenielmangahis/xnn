...
<link rel="stylesheet" href="$commission_engine_api_url/css/admin_run_sandbox.css?v=1" />
...
<div class="run-commission tool-container tool-container--default" v-cloak>
    <div class="row">
        <div class="col-md-12">
            <h4 class="tool-container__header" id="tool-container__header">Generate Commission (Sandbox)</h4>
            <hr />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal test-noel">
                <div class="form-group">
                    <div class="form-sub-group col-md-4 col-sm-12 col-xs-12" style="margin-bottom:15px">
...
<script src="$commission_engine_api_url/js/admin_run_sandbox.js?v=1.1"></script>
