...
<link rel="stylesheet" href="$commission_engine_api_url/css/admin_sandbox_settings.css?v=1" />
...
<div id="sandbox-settings" class="sandbox-settings tool-container tool-container--default" v-cloak>
    <div class="row">
        <div class="col-md-12">
...
<script src="$commission_engine_api_url/js/admin_sandbox_settings.js?v=1.1"></script>
EOS
1;