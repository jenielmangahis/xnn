...
<div class="historical-commission tool-container tool-container--default" v-cloak>
    <div class="row">
        <div class="col-md-12">
            <h4 class="historal-comission-label">Historical Commission</h4>
            <hr />
        </div>
    </div>
        ...
        <div class="col-md-6 col-xs-12">
            <form class="form-horizontal" style="margin-bottom: 15px;">
                <div class="form-group">
                    <div class="col-md-6">
                        <label for="frequency"><span class="frequency-label">Frequency</span> <span class="text-danger">*</span></label>
                        <select disabled
                            ...
                            <option v-else-if="frequencyState === 'loaded'" value="" selected disabled class="select-frequency-label">
                                Select a frequency
                            </option>
                    ...
                    <div class="col-md-6">
                        <label for="commission_type" class="commission-type-label">Commission Type</label>
                        <select
                        ...
                        >
                            <option value="" selected disabled class="select-type-label">Select a type</option>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="commission_period"><span class="commission-period-label">Commission Period</span> <span class="text-danger">*</span></label>
                        <select
                                disabled
                        ...
                        >
                            ...
                            <option v-else-if="commissionPeriodState === 'loaded'" value="" class=select-commission-drop selected disabled>
                ...
                <div class="form-group">
                    <div class="col-md-12 assoc_filter_area">
                        <label class="associate-label">Associate</label>
                        <select2-autocomplete-member v-on:select-change="selectionChange" :id="filters.downline_id" :url="autocomplete_url" v-model="filters.downline_id"></select2-autocomplete-member>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-2">
            <button
                    ...
                    class="btn btn-info btn-block btn-sm download-label"
        ...
        <div class="col-sm-10">
            <div class="pull-right">
                <h5><strong><span class="his-total-label">Total</span> &euro; {{ total }}</strong></h5>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table id="table-historical-commission" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tr class="table__row">
                    <th class="table__cell th-commission-type-label">Commission Type</th>
                    <th class="table__cell th-commission-period-label">Commission Period</th>
                    <th class="table__cell">POD/PDR</th>
                    <th class="table__cell th-account-type-label">Account Type</th>
                    <th class="table__cell th-assoc-id-label">Associate ID</th>
                    <th class="table__cell associate-label">Associate</th>
                    <th class="table__cell th-amount-earned">Amount Earned</th>
                    <th class="table__cell th-current-title-label">Current Title</th>
