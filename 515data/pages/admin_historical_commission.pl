    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <form class="form-horizontal" style="margin-bottom: 15px;">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="userId">Payee</label>
                        <select2-autocomplete-member :url="autocompleteUrl" v-model="userId"></select2-autocomplete-member>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="pull-right">
                <h5><strong>Total &euro;{{ total }}</strong></h5>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <table id="table-historical-commission" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tr class="table__row">
                    ...
                    <th class="table__cell">Ref ID</th>
