        ...
        <div class="col-md-12">
            ...
            <table id="table-minimum-rank" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tr class="table__row">
                    ...
                    <th class="table__cell">Current Title</th>
            ...
            <form class="modal-content" id="form-minimum-rank" >
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="user_id">Associate</label>
                ...
                <div class="modal-footer">
                    <button class="btn btn-default" data-dismiss="modal" v-show="isProcessing === 0">Close</button>
