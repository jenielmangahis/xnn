                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form>
                                ...
                                <div class="form-group">
                                    <label>Step 2: Select which associate to move</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required v-model="approved_by" id="approved_by" class="form-control" />
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dt-responsive nowrap" id="table-history" style="width:100%">
                            ...
                            <tr class="table__row">
                                ...
                                <th class="table__cell">Moved By</th>
                                <th class="table__cell">Authorized By</th>
