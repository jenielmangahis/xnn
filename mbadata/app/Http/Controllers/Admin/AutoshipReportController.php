...
class AutoshipReportController extends Controller
{
    ...
    {   
        sleep(2);
        return response()->json([
            'link' => $this->auto_ship->getLinkCsvActiveMembersOnAutoship($request->all())
        ]);
    }
    ...
    {   
        sleep(2);
        return response()->json([
            'link' => $this->auto_ship->getLinkCsvPendingAutoship($request->all())
        ]);
    }
    ...
    {   
        sleep(2);
        return response()->json([
            'link' => $this->auto_ship->getLinkCsvFailedAutoship($request->all())
        ]);
    }
