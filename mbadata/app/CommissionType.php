...
class CommissionType extends Model
{
    ...
    public static function generateCommissionPeriods()
    {
        ...
        foreach ($commission_types as $commission_type) {
            ...
            if($commission_type->frequency == 'annual')  {
            ...
            else if($commission_type->frequency == 'semi-monthly') {
                $day = $commission_period == null ?
                    date('d') :
                    date('d', strtotime($commission_period->start_date));
