...
<div class="tool-container tool-container--default" id="app-clawback">
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="tool-container__header mb-5">CLAWBACK/REFUND/MOVE ORDERS</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12" >
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-move-log-tab" data-toggle="tab" href="#nav-move-logs" role="tab" aria-controls="nav-move-logs" aria-selected="false">Move Logs</a>    
                </div>
            </nav>
            <!-- Tab panes -->
             <div class="tab-content" id="nav-tabContent">
                <div role="tabpanel" class="tab-pane active" id="nav-orders" aria-labelledby="nav-orders-tab">
                     <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal font-weight-bold">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <button id="button-view-orders" type="button" class="new-btn-mba generate-width btn btn-primary" >View Orders</button>
                                    </div>
                                </div>
                            </form>
                        </div>            
                ...
                <div role="tabpanel" class="tab-pane form-group" id="nav-move-logs">
                    <div class="table-responsive">
                    ...
                    <div class="table-responsive">
                        <table id="table-order-items" class="table table table-striped" >
                            ...
                            <tr v-if="products.length == 0" class="table__row text-center">
                                <td v-if="is_processing == 1" colspan="8">Fetching <i class="fa fa-spinner fa-pulse"></i></td>
                                <td v-else="is_processing == 0" colspan="8">No data available in table</td>
                            </tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input :readonly="order.is_clawback ? true : (order.is_full_order ? true : false)" v-on:keyup="keyupPercent" v-model.number="order.percentage_off" type="number" id="order_percentage" name="percent" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input :readonly="order.is_clawback ? true : (order.is_full_order ? true : false)" v-on:keyup="keyupAmount" v-model.number="order.amount_off" type="number" id="order_amount" name="amount" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 text-center">
                    ...
                    <div class="">
                        <label>
                            <input type="checkbox" value="1" name="is_full_order"
                                :disabled="order.is_clawback ? true : false" 
                                :readonly="order.is_clawback ? true : false" 
                                v-on:change="changeIsFullOrder" 
                                v-model="order.is_full_order" 
                            >
                            Full Order
                        </label>
                    </div>
