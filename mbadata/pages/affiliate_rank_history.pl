        ...
        <div class="col-md-12">
             ...
             <nav>
                <div class="nav nav-tabs font-weight-bold" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-tree-tab" data-toggle="tab" href="#nav-tree" role="tab" aria-controls="nav-tree" aria-selected="true">Enrollment Tree $rank_title_plural</a>
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-row">
                                     <div class="form-group col-md-3">
                                        <button
                                                type="button"
                                                class="new-btn-mba btn btn btn-primary btn-block"
