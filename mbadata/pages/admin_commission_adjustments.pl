...
<div class="tool-container tool-container--default" >
	<div class="row">
        <div class="col-md-12">
            <h4 class="tool-container__header mb-5">Commission Adjustments</h4>
        </div>
    </div>
	...
	<div class="row">
		<div class="col-md-12">
            <div class="tool-container__actions pull-left">
				<button type="button" class="new-btn-mba btn btn-success" v-on:click.prevent="showCreateModal">
					New adjustment
				</button>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<table class="table table-striped table-bordered nowrap" id="table-adjustments" style="width:100%">
            		...
            		<form class="form-horizontal" style="margin-bottom: 15px;">
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<select name="commission_type" id="commission_type" class="form-control" v-model="filters.commission_type_id" :disabled="!!isViewMode">
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<select disabled name="commission_period" id="commission_period" class="form-control" v-model="filters.commission_period_id" v-bind:disabled="commissionPeriodState !== 'loaded'" :disabled="!!isViewMode">
...
<script src="$commission_engine_api_url/js/admin_commission_adjustments.js?v=1.0&app=$app_js_version"></script>
