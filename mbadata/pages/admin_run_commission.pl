...
<div class="run-commission tool-container tool-container--default">
    <div class="row">
        <div class="col-md-12">
            <h4 class="tool-container__header mb-5" id="tool-container__header">Generate Commissions</h4>
            ...
            <form class="form-horizontal font-weight-bold">
                 <div class="form-row">
                   <div class="form-group col-md-4 col-sm-12 col-xs-12">
                        ...
                        <select v-model="commissionType" id="commission-type" class="new-mba-border-color form-control" v-on:change="onChangeCommissionTypes" :disabled="background != null && background.is_running == 'YES' || is_generating == 1 ? true : false">
                    ...
                    <div class="form-group col-md-4 col-sm-12 col-xs-12">
                        ...
                        <select v-on:change="onChangeCommissionPeriods" v-model="commissionPeriod" id="commission-period" class="new-mba-border-color form-control" :disabled="commissionPeriods.length == 0 || (background != null && background.is_running == 'YES' || is_generating == 1) ? true : false">
                   ...
                   <div class="form-group col-md-4 col-sm-12 col-xs-12 mba-mobile-view-center">
                        <label>&nbsp;</label><br/>
                        <button v-if="background == null || background.is_running !== 'YES'" v-on:click="run" :disabled="commissionType === '' || commissionPeriod === '' || is_generating == 1 ? true : false" class="new-btn-mba generate-width btn btn-primary " type="button">
                ...
                <div class="form-group" v-if="commissionType != '' && commissionPeriod != '' && background == null">
                    <div class="form-sub-group col-lg-4 mba-mobile-view-center">
                        <button :disabled="is_viewing_previous_run == 1 ? true : false" v-if="commissionType != '' && commissionPeriod != '' && background == null && is_generating == 0" v-on:click="viewPreviousRun" class="new-btn-mba btn btn-sm btn-info text-uppercase" type="button">
    ...
    <div class="row" v-show="background != null">
        <div class="col-md-12 mba-color">
            ...
            <div v-if="background != null && +background.is_report_generated === 1">
                ...
                <div class="commission-dl-btn mba-mobile-view-center" v-if="background != null && (background.download_link != '' && background.download_link != null)">
                    <a class='new-btn-mba btn btn-success run-commission__download-link'  :href="background != null ? background.download_link : ''" download>
                        <i class="fa fa-th-list" aria-hidden="true"></i> Download Commission Payouts
                    </a><br />
                    <a class='new-btn-mba btn btn-success run-commission__download-link'  :href="background != null ? background.download_details_link : ''" download>
            ...
            <div v-if="background != null && background.is_running == 'COMPLETED'">
                ...
                <div class="mba-mobile-view-center"> 
                    <button type="button" class="new-btn-mba btn btn-danger" v-on:click="lockCommissionPeriod" :disabled="is_locking == 1 ? true : false">
