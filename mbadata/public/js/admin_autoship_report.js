(function ($, api_url, Vue, swal, axios, location, moment, undefined) {
    ...
    const client = commissionEngine.createAccessClient('admin/autoship');
        ...
        methods: {
            initializeDataTables() {
                ...
                this.dtPendingAutoship = $("#table-pending-autoship").DataTable({
                    ...
                    // responsive: true,
                    ajax: {
                        url: `${api_url}admin/autoship/pending-autoship`,
                        data: function (d) {
                ...
                this.dtSuccessfulAutoship = $("#table-successful-autoship").DataTable({
                    ...
                    // responsive: true,
                    ajax: {
                        url: `${api_url}admin/autoship/successful-autoship`,
                        data: function (d) {
                            d.year_month = _this.filters.yearMonth;
                        },
                    },
                ...
                this.dtFailedAutoship = $("#table-failed-autoship").DataTable({
                    ...
                    // responsive: true,
                    ajax: {
                        url: `${api_url}admin/autoship/failed-autoship`,
                        data: function (d) {
                            d.year_month = _this.filters.yearMonth;
                        },
                    },
                ...
                this.dtCancelledAutoship = $("#table-cancelled-autoship").DataTable({
                    ...
                    // responsive: true,
                    ajax: {
                        url: `${api_url}admin/autoship/cancelled-autoship`,
                        data: function (d) {
                            d.year_month = _this.filters.yearMonth;
                        },
                    },
                ...
                this.dtActiveMembersOnAutoship = $("#table-active-members-on-autoship").DataTable({
                    ...
                    // responsive: true,
                    ajax: {
                        url: `${api_url}admin/autoship/active-members-on-autoship`,
                        data: function (d) {
                            d.year_month = _this.filters.yearMonth;
                        },
                    },
