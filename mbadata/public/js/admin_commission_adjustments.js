(function ($, api_url, Vue, swal, axios, location, undefined) {
    ...
    const vm = new Vue({
        ...
        data: {
            ...
            autocompleteUrlMembers: `${api_url}common/autocomplete/members`,
        ...
        methods: {
            ...
            showViewModal(adjustment) {
                ...
                this.isEditMode = 0;
                this.isCreateMode = 0;
                this.filters.commission_type_id = adjustment.commission_type_id;
                this.getCommissionPeriods(() => {
                    this.filters.commission_period_id = adjustment.commission_period_id;
                });
        ...
        watch: {
            'filters.commission_type_id': function (newType, oldType) {
