        ...
        methods: {
            ...
            onSubmit: function (type) {
                ...
                swal({
                    ...
                    if(_this.is_processing == 1) return;
            ...
            onSubmitRefund: function (type){
                ...
                if($this.order.is_clawback == 1) return;
                    ...
                    .then((submitRefund) => {
                        ...
                        if(submitRefund) {
                            ...
                            $.post(api_url + 'admin/clawback/refund-order', 
                                $form.serialize() + "&set_user_id=" + $('#member').val() + "&type=" + type, 
                                function (result) {
            ...
            save() {
                ...
                .then((moveOrder) =>{
                    ...
                    if(moveOrder) {
                        ...
                        client.post(`admin/move-order/orders/${this.order.order_id}/change`, {modified: $('#member').val(), ...this.order})
                        .then(response => {
            ...
            axiosErrorHandler(error) {
                ...
                if(error.hasOwnProperty('response')) {
                    data = commissionEngine.parseAxiosErrorData(error.response.data)
                } else {
                    data = commissionEngine.parseAxiosErrorData(error.responseJSON);
                }
