    ...
    const vm = new Vue({
        ...
        methods: {
            ...
            clear() {
                ...
                this.selected_leg_position = null;
            },
            viewDetails() {
                ...
                if(this.tree_id == 2 && !this.leg_position) {
                    this.error.message = "Leg position is required";
                    return;
                }

                console.log(this.leg_position);
                this.is_processing = 1;

                client.get(`admin/sponsor-change/relationship?tree_id=${this.tree_id}&member_id=${this.member_id}&sponsor_id=${this.sponsor_id}&leg_position=${this.leg_position}`).then(response => {
                    ...
                    this.selected_leg_position = this.leg_position;
                  ...
                  .then((changeSponsor) => {
                    ...
                    if(changeSponsor) {
                        ...
                        client.post(`admin/sponsor-change/change`, {
                            ...
                            leg_position: this.selected_leg_position,
