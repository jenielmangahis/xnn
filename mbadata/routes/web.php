...
Route::prefix('common/autocomplete')->namespace('Common')->group(function(){
    ...
    Route::get('binary-downline', 'AutocompleteController@binaryDownline')->middleware('jwt.auth');
...
Route::prefix('member/enroller-tree')->namespace('Member')->middleware('jwt.auth')->group(function(){
    Route::get('parent/{id}', 'EnrollerTreeController@parent');
    Route::get('parent/{id}/children/{page_no}', 'EnrollerTreeController@children');
    Route::get('order-history', 'EnrollerTreeController@orderHistory');
    Route::get('active-personal-enrollment', 'EnrollerTreeController@activePersonalEnrollment');
});
...
Route::prefix('member/dashboard')->namespace('Member')->middleware('jwt.auth')->group(function(){
    ...
    Route::get('current-binary-details', 'DashboardController@currentBinaryDetails');
...
Route::prefix('member/payeer')->namespace('Member')->middleware('jwt.auth')->group(function(){
    Route::post('create', 'PayeerController@createUser');
    Route::get('users', 'PayeerController@getUser');
    Route::post('update', 'PayeerController@updateUser');
});
...
Route::prefix('member/binary-tree')->namespace('Member')->middleware('jwt.auth')->group(function() {
    Route::get('{root}/downline/{user_id?}', 'BinaryTreeController@getDownline');
    Route::get('user-details', 'BinaryTreeController@getUserDetails');
    Route::patch('user/placement-preference', 'BinaryTreeController@updatePlacementPreference');
});
...
Route::prefix('admin/dashboard')->namespace('Admin')->middleware('jwt.auth.level:1,6')->group(function () {
    ...
    Route::get('new-ibo-count', 'DashboardController@getNewIBOCount');
    Route::get('new-ibo-with-product-subscription-count', 'DashboardController@getNewIBOWithProductSubscriptionCount');

    Route::get('total-sales/platinum-package', 'DashboardController@getPlatinumPackageTotalSales');
    Route::get('total-sales/gold-package', 'DashboardController@getTransformationPackTotalSales');
    Route::get('total-sales/gold-package', 'DashboardController@getGoldPackageTotalSales');
    Route::get('total-sales/ibo-only', 'DashboardController@getIBOTotalSales');
    ...
    Route::get('new-ibo', 'DashboardController@getNewIBO');
    Route::get('new-ibo-with-product-subscription', 'DashboardController@getNewIBOWithProductSubscription');

    Route::get('sales/platinum-package', 'DashboardController@getPlatinumPackageSales');
    Route::get('sales/gold-package', 'DashboardController@getGoldPackageSales');
    Route::get('sales/ibo-only', 'DashboardController@getIBOSales');
