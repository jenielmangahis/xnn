...
class RunCommission
{
    ...
    public static function getCommissionTypeClass($commission_type_id, $commission_period_id, $background_worker_id = null, $background_worker_process_id = null)
    {
        ...
        echo "Config ID fast start " . config('commission.commission-types.fast-start-bonus') . "<br />";
        echo "Config ID acquisition " . config('commission.commission-types.customer-acquisition-bonus');exit;
