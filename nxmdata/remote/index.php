...
html +='<form id="chatSubmissionScript" name="signupform" method="post" action="/cgi/signup_gro.cgi"  class="lc-form-horizontal">';
...
html +='<input type="hidden" value="<?php echo $_GET["rkz"]?>" name="key">';
...
$(document).on('click', '#lc-btn-submit-offline-msg', function(e) {
	 e.preventDefault();
		$.ajax({
			url: "http://igrowspeed.net/cgi/signup_gro.cgi",
			type: "post",
