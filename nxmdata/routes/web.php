...
Route::prefix('v1')->group(function () {
	Route::prefix('common')->namespace('Common')->group(function() {
		Route::get('frequencies', 'CommissionTypesController@frequencyTypes');
		Route::get('commission-types', 'CommissionTypesController@commissionTypes');
		Route::get('commission-periods', 'CommissionTypesController@commissionPeriods');
		Route::get('ranks', 'RankController@getRanks');
	});

	Route::prefix('member')->namespace('Member')->middleware('jwt.auth')->group(function() {
		Route::get('historical-commission', 'HistoricalCommissionController@getHistoricalCommissions');
		Route::get('gift-cards', 'RewardsController@getGiftCards');
		Route::get('highest-rank-achieved', 'RankHistoryController@getHighestRankAchieved');
		Route::get('current-period-orders', 'DashboardController@getCurrentPeriodOrders');
		Route::get('rank-progress', 'RankProgressController@getProgress');
		Route::get('current-rank', 'DashboardController@getCurrentRankDetails');
		Route::get('my-earnings', 'DashboardController@getMyEarnings');
		Route::get('my-rank', 'DashboardController@getCurrentRank');
	});
});