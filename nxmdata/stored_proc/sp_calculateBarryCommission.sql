DROP PROCEDURE IF EXISTS sp_calculateBarryCommission;
DELIMITER //
CREATE PROCEDURE sp_calculateBarryCommission(
...
BEGIN
	...
	ActiveUsersLoop: LOOP
		...
		SET v_commissionValue = sp_getTotalBarryCommPerAffiliate(
