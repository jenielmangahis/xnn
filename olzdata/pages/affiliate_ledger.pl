            ...
            <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ledger-actions ">
                                <div class=" pull-left">
                                <button class="new-btn-olz btn btn-primary" v-on:click.stop="refresh">REFRESH</button>
                                </div>
                                <div class=" pull-right">
                                    <button class=" new-btn-olz btn btn-success" v-on:click.stop="showTransfer">TRANSFER</button>
                                    <button class=" new-btn-olz btn btn-danger" v-on:click.stop="showWithdraw">WITHDRAW</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="nav-withdrawals" role="tabpanel" aria-labelledby="nav-withdrawals-rank">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ledger-actions ">
                                <button class="new-btn-olz btn btn-primary pull-left" v-on:click.stop="refresh">REFRESH</button>
                            </div>
                        </div>
                    </div>
